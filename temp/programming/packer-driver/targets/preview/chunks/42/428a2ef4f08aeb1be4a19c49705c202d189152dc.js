      ...
      _export("Lobby", Lobby = (_dec = ccclass('Lobby'), _dec2 = property({
        ...
        generateCovers(coverData) {
          ...
          var _loop = function _loop(i) {
            var coverNode = instantiate(_this.coverPrfb);
            coverNode.name = '' + i;
            coverNode.parent = _this.node;
            ...
            if (i < coverData.length) {
              ...
              loader.loadRes(data.coverImgUrl, Texture2D, (err, texture) => {
                ...
                if (i === coverData.length - 1) {
                  _this.tweenToIndex(_this._curIndex, true);
                }
              });
            }

            _this._coverList.push(coverNode);
          };
...
//# sourceMappingURL=428a2ef4f08aeb1be4a19c49705c202d189152dc.js.map